...
class RecommendationEngine:
    ...
    def __init__(self, sc, dataset_path):
        ...
        # Load ratings datasets for later use
        logger.info("Loading Ratings datasets...")
        ...
        # Load movies datasets for later use
        logger.info("Loading Movies datasets...")
    ...
    def __count_and_average_ratings(self):
        ...
        the current datasets self.ratings_RDD
        """
